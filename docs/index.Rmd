...
# Background
Malaria is a serious and common infectious disease that is caused by a mosquito parasite.^1^ Those who contract Malaria typically exhibit flu-like symptoms including fever and chills. In 2019, before the COVID-19 pandemic, there were over 229 million reported cases and 405,000 attributable deaths to malaria.^2^ The disease burden of malaria is largely concentrated in sub-Saharan Africa, as the region accounted for 94% of cases and 85% of recorded deaths in 2019.^3^ (REF 1)
...
## Model Evaluation 
  ...
  From the best fitting model, variable selection will be preformed using forward step wise regression. Variable selection for the final model will be determined by evaluating the test error of each forward step wise model, with the lowest test error preferred. (REF3 )
...
1. Talisuna A, Adibaku S, Dorsey G, Kamya MR, Rosenthal PJ. Malaria in Uganda:
Challenges to control on the long road to elimination. II. the path forward. Acta Trop.
2012;121(3):196-201. doi:10.1016/j.actatropica.2011.06.013
2. PRISM ICEMR Cohort. Clinical epidemiology database web site.
https://l2.clinepidb.org/ce.legacy/app/record/dataset/DS_0ad509829e#category:topic-
0219-synonym . Published 2018. Accessed November 16, 2022.
3. An Introduction to Statistical Learning with Applications in R Second Edition (need full book title)
